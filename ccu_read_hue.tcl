...
if {$lightNr == "0"} {
	...
	deleteVariablen "${pre}1"
	deleteVariablen "${pre}2"
    deleteVariablen "${pre}3"
    deleteVariablen "${pre}4"
    deleteVariablen "${pre}5"
    deleteVariablen "${pre}6"
    deleteVariablen "${pre}7"
    deleteVariablen "${pre}8"
    deleteVariablen "${pre}9"
    deleteVariablen "${pre}10"
    deleteVariablen "${pre}11"
    deleteVariablen "${pre}12"
	exit
}
