...
CGPoint _realXY  (CGPoint xy, float redX, float redY, float greenX, float greenY, float blueX, float blueY) ;
...
Color colorFromXY (CGPoint xy, float redX, float redY, float greenX, float greenY, float blueX, float blueY);
CGPoint calculateXY (Color color, float redX, float redY, float greenX, float greenY, float blueX, float blueY);
...
const char * realXY (float x, float y, float redX, float redY, float greenX, float greenY, float blueX, float blueY) {
    ...
    // } 
    CGPoint xy = _realXY  (CGPointMake(x, y), redX, redY, greenX, greenY, blueX, blueY);
    static char ss1[14];
...
Color colorFromXY (CGPoint xy, float redX, float redY, float greenX, float greenY, float blueX, float blueY) {
    xy = _realXY(xy, redX, redY, greenX, greenY, blueX, blueY);
...
const char* calcRGB (float x, float y, float redX, float redY, float greenX, float greenY, float blueX, float blueY) {
    ...
    // sscanf(xy, "%f,%f", &x,&y);
    static char s[7];
    Color color = colorFromXY (CGPointMake(x,y), redX, redY, greenX, greenY, blueX, blueY);
    int r,g,b;
...
const char* calcXY (const char *rgb, float redX, float redY, float greenX, float greenY, float blueX, float blueY){
    ...
    CGPoint x_y = calculateXY(color, redX, redY, greenX, greenY, blueX, blueY);
    static char ss[14];
